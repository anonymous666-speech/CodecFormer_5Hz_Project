...
class AudioTokenizer(AbsTokenizer):
    def __init__(self, 
        ...
        config_path = f'/apdcephfs/share_302533218/shaunxsyang/speech_projects/UniAudio/UniAudio/checkpoints/{tag}_model/config.yaml'
        if not os.path.isfile(config_path):
            raise ValueError(f"{config_path} file does not exist.")
        config = OmegaConf.load(config_path)
        self.ckpt_path = f"/apdcephfs/share_302533218/shaunxsyang/speech_projects/UniAudio/UniAudio/checkpoints/{tag}_model/model.pth"
