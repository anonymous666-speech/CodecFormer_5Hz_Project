...
class SemanticTokenizer(AbsTokenizer):
    def __init__(self, device=torch.device('cpu'), duplicate=True):
        ...
        self.hubert_path = '/apdcephfs/share_302533218/shaunxsyang/speech_projects/UniAudio/UniAudio/checkpoints/hubert_base_ls960.pt'
        self.quantizer_path = '/apdcephfs/share_302533218/shaunxsyang/speech_projects/UniAudio/UniAudio/checkpoints/hubert_base_ls960_L9_km500.bin'
