...
class AudioPromptTokenizer(AbsTokenizer):
    ...
    def tokenize_spk(self, x, task=None, cache=None):
        ...
        for _ in range(5):
            ...
            self.prompt_dict[uttid] = audio
            # torch.save(self.prompt_dict, f'/apdcephfs/share_302533218/shaunxsyang/speech_projects/UniAudio/UniAudio/egs/TTS/save_prompt/{uttid}.pt'        )# [YXS] add for prompt save
